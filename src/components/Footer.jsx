...
const Footer = () => {
    ...
    const hiddenScreenStatus = useSelector(state=>state.hiddenScreens.mailAcceptance);
    ...
    const socialBlock = socialIcons.map((item, index)=>{
        return <div key={index} className="footer__bottom__social__item">
                    <img src={item}/>
                </div>
    });
        ...
        <div className="footer">
            ...
            <div className="footer__row">
                <div className="footer_row__about">
                    <h4>About Us</h4>
                    <p>The state of Utah in the United States is home to lots of beautiful National Parks, & Bryce Canyon National Park ranks as three of the magnificent & awe inspiring.</p>
                </div>
